    ...
    methods
        ...
        function self = GECCO(Architectures,Conditions)
            ...
            % Otherwise instantiate a default architecture
                ...
                self.DataNames = {'Atmosphere_CO2','Algae','Phosphate','DIC','Alkalinity'};
                self.Carbonate.Distribution = zeros(1000,1);
            end
        end
        ...
        function ModelCell = Split(self);
            ...
            for n = 1:RunNumber;
                ...
                ModelCell{1,n}.Carbonate = self.Carbonate;
                ModelCell{1,n}.Metamorphism = self.Metamorphism;
        ...
        function Merge(self,ModelCell);
            ...
            for ModelNumber = 1:numel(ModelCell);
                ...
                Metamorphism = ModelCell{ModelNumber}.Metamorphism;
            end
        ...
        function ConstNamesClean = GetCleanConstNames(self);
            ...
            RemovedNames = {'PressureCorrection','k0_Matrix','k1_Matrix','k2_Matrix','kb_Matrix','kw_Matrix','ksp_cal_Matrix','ksp_arag_Matrix','ks_Matrix','FitMatrix','Metamorphism_Age','Metamorphism_Gauss'};
