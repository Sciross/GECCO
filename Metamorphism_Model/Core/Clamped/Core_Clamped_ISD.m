function dy = Core_Clamped_ISD(t,y,GECCOObject)
% Change Values
...
%% Surface DIC - 5
DIC.Flux(1,1) = DICRiverineFlux + DICMixingFlux - BiologicalPICExport + PICBiologicalFlux(1) - BiologicalPOCExport + POCBiologicalFlux(1) - GasFlux + ((2.1-y(5)).*GECCOObject.Conditions.Present.MixingCoefficient.*GECCOObject.Architectures.BoxArea);
