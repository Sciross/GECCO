...
GECCOObject.Metamorphism(MetaBoxes(1):MetaBoxes(2)) = GECCOObject.Metamorphism(MetaBoxes(1):MetaBoxes(2))+((Metamorphism.Added.*GECCOObject.Conditions.Present.Metamorphism_Gauss).*GECCOObject.dt);

Outgassing = (GECCOObject.Metamorphism(1+floor(t/GECCOObject.Conditions.Present.Metamorphism_Resolution))/GECCOObject.Conditions.Present.Metamorphism_Resolution).*GECCOObject.dt;

%% Weathering
Weathering = GECCOObject.Conditions.Present.Riverine_Carbon.*GECCOObject.Conditions.Present.Riverine_Volume;

%% CO2
CO2.Flux = GasFlux + Outgassing - Weathering;
dy(1) = 0; %CO2.Flux./GECCOObject.Conditions.Present.Atmosphere_Volume;
