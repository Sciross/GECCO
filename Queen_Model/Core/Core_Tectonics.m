function [dy,dy_Sub,dy_Outgas] = Core_Tectonics(t,y,y_Sub,y_Outgas,Chunk_Number,Model)
    % Change Values
    ...
    Model.Conditions.Presents.Outgassing.Gauss = GenerateGaussian([-Model.Conditions.Presents.Outgassing.Spread*3:Model.Conditions.Presents.Outgassing.Temporal_Resolution:Model.Conditions.Presents.Outgassing.Spread*3],[Model.Conditions.Presents.Outgassing.Spread,0]);
    Model.Conditions.Presents.Outgassing.Gauss = (Model.Conditions.Presents.Outgassing.Gauss/sum(Model.Conditions.Presents.Outgassing.Gauss))';
