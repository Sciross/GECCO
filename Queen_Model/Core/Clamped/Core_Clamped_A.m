function [dy,dy_Sub,dy_Outgas] = Core_Clamped_A(t,y,y_Sub,y_Outgas,Chunk_Number,Model)
% Change Values
...
% Model.Conditions.Presents.Carbonate_Chemistry.Lysocline = Model.Conditions.Presents.Carbonate_Chemistry.Lysocline;
