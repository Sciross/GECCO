...
%             self.ConstTableUI.Data = [];
        ...
        function SetOutputFilepath(self,src,event);
            ...
            if OutputFilepath~=0;
                ...
                self.Gecco.Information.OutputFilepath = OutputFilepath;
            end
        end
        ...
        function SetInputFile(self,src,event);
            if InputFilename~=0;
                self.Gecco.Information.InputFile = [InputFilepath,InputFilename];
                self.InputFileUI.String = self.Gecco.Information.InputFile;
            end
        end
...
%                     self.UpdateLogBox("Warning: File extension changed to .nc");
        ...
        function SetOutputFilename(self,src,event);
            self.Gecco.Information.OutputFilename = src.String;
        end
        ...
        function SetFilepath(self,src,event,Filepath);
            ...
            if strcmp(src.Tag,"SplashInputFileBrowseButton") || strcmp(src.Tag,"SplashInputFilename") || strcmp(src.Tag,"RunLoadButton");
                if ~strcmp(ValidFilepath,"");
                    ...
                    self.Gecco.Information.InputFile = ValidFilepathWithNC;
            ...
            elseif strcmp(src.Tag,"SplashOutputFilepathBrowseButton") || strcmp(src.Tag,"SplashOutputFilepath");
                if ~strcmp(ValidFilepath,"");
                    ...
                    self.Gecco.Information.OutputFilepath = ValidFilepath;
            ...
            elseif strcmp(src.Tag,"SplashOutputFilename");
                if ~strcmp(ValidFilepath,"");
                    ...
                    self.Gecco.Information.OutputFilename = ValidFilepathWithNC;
        ...
        function SetSplashPaths(self);
            if strcmp(self.Gecco.Information.InputFile,"") || isempty(self.Gecco.Information.InputFile);
                self.SplashInputFileUI.String = "Input File";
            else
                self.SplashInputFileUI.String = self.Gecco.Information.InputFile;
                self.SplashInputFileUI.Enable = "On";
                self.SplashInputFileUI.ForegroundColor = self.Colours.black;
            end
            
            if strcmp(self.Gecco.Information.OutputFilepath,"") || isempty(self.Gecco.Information.OutputFilepath);
                self.SplashOutputFilepathUI.String = "Output Filepath";
            else
                self.SplashOutputFilepathUI.String = self.Gecco.Information.OutputFilepath;
                self.SplashOutputFilepathUI.Enable = "On";
                self.SplashOutputFilepathUI.ForegroundColor = self.Colours.black;
            end
            
            if strcmp(self.Gecco.Information.OutputFilename,"") || isempty(self.Gecco.Information.OutputFilename);
                self.SplashOutputFilenameUI.String = "Output Filename";
            else
                self.SplashOutputFilenameUI.String = self.Gecco.Information.OutputFilename;
...
%                 end
        ...
        function LoadCondType(self,src,event);
            File = self.Gecco.Information.InputFile;
            if ~strcmp(File,"");
