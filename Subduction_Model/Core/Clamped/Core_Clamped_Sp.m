function dy = Core_Clamped_Sp(t,y,GECCOObject)
% Change Values
...
%% Carbonate Chemistry
[~,GECCOObject.Conditions.Present.CO2,~,~,GECCOObject.Conditions.Present.OmegaC,~] = CarbonateChemistry(GECCOObject.Conditions.Present,[y(5);y(6)],[y(7);y(8)],GECCOObject.Conditions.Present.HIn,GECCOObject.Conditions.Present.CarbonateConstants);
