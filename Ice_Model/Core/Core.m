...
% Lysocline
Model.Conditions.Present.Lysocline = Lysocline_Solver_Regula_Falsi(y(6),Model.Architectures.Midpoints,y(10:11),Model.Conditions.Present.Salinity,Model.Conditions.Present.pH,Model.Conditions.Present.Calcium,Coefficients,Model.Conditions.Present.Lysocline,0);
% Lysocline_Solver_Regula_Falsi(DIC,Midpoints,Temperature,Salinity,pH,Calcium,Coefficients,Lysocline_In,Iteration_Flag,Tolerance);
