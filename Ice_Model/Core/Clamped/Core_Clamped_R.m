...
Outgassing = ((y_Meta(1+floor((t)/Model.Conditions.Present.Outgassing_Temporal_Resolution))/Model.Conditions.Present.Outgassing_Temporal_Resolution));
...
%% Temperature
dy(16) = 0; %Model.Conditions.Present.Radiative_Sensitivity.*1.4427.*log((y(1)+dy(1))/y(1));
