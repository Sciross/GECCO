...
Carbonate.ShiftedIn = [0;y_Sub(1:end-1)].*GECCOObject.Conditions.Present.SubductionRate;
Carbonate.ShiftedOut = y_Sub.*GECCOObject.Conditions.Present.SubductionRate;

Carbonate.Removed = (y_Sub.*GECCOObject.Conditions.Present.SubductionRisk);
...
T_eq = ((GECCOObject.Conditions.Present.Solar_Constant.*(1-GECCOObject.Conditions.Present.Albedo) + (4.*y(16)))./(4.*GECCOObject.Conditions.Present.Emissivity*GECCOObject.Conditions.Present.Stef_Boltz)).^0.25;
