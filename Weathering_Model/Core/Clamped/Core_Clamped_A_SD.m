...
dy(14) = ((Model.Conditions.Present.Silicate_Coefficient(1).*Model.Conditions.Present.Silicate_Coefficient(2).*exp(Model.Conditions.Present.Silicate_Coefficient(2).*y(9)))*(dy(9))) + (((2*exp((-y(12)/Model.Conditions.Present.Silicate_Limiting_Threshold)).^2)/sqrt(pi)));
dy(15) = ((Model.Conditions.Present.Carbonate_Coefficient(1).*Model.Conditions.Present.Carbonate_Coefficient(2).*exp(Model.Conditions.Present.Carbonate_Coefficient(2).*y(9)))*(dy(9))) + (((2*exp((-y(13)/Model.Conditions.Present.Carbonate_Limiting_Threshold)).^2)/sqrt(pi)));
