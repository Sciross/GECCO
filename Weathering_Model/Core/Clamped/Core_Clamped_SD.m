...
POCSurfArray = [zeros(numel(1:Model.Conditions.Present.POC_Burial_Indices(1)-1),1);ones(numel(Model.Conditions.Present.POC_Burial_Indices(1):Model.Conditions.Present.POC_Burial_Indices(2)),1); zeros(numel((Model.Conditions.Present.POC_Burial_Indices(2)+1):1000),1)];
...
Carbonate_ShiftedIn = [0;y_Sub(1:end-1)].*Model.Conditions.Present.Subduction_Rate;
