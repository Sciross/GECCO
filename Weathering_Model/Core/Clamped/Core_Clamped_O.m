...
Outgassing_Amp = ((y_Meta(1+floor((0)/Model.Conditions.Present.Outgassing_Temporal_Resolution))/Model.Conditions.Present.Outgassing_Temporal_Resolution))/(Model.Conditions.Initial.Outgassing(1)/Model.Conditions.Present.Outgassing_Temporal_Resolution);
Carbonate_Amp = y(13)/Model.Conditions.Initial.Carbonate;
Carbonate_Assimilated = 3e12*Outgassing_Amp*Carbonate_Amp;
Outgassing = ((y_Meta(1+floor((0)/Model.Conditions.Present.Outgassing_Temporal_Resolution))/Model.Conditions.Present.Outgassing_Temporal_Resolution)) + Carbonate_Assimilated;
...
dy(13) = sum(Carbonate_Obducted)/(1/(1-Model.Conditions.Present.Carbonate_Replacement)) + Carbonate_Unearthed - Carbonate_Weathering - Carbonate_Assimilated/(1/(1-Model.Conditions.Present.Carbonate_Replacement));
